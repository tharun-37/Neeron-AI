...
SYSTEM_PROMPT = (
    ...
    "MANDATORY SELENIUM BROWSER MODE: Whenever the user command or voice prompt mentions 'browser', 'chrome', 'firefox', websites, or web searching, you MUST operate strictly in Selenium Browser Mode (using 'open_browser', 'browser_click', 'browser_type', 'browser_scroll'). Do NOT take desktop screenshots or use pixel coordinate GUI clicks for browser tasks. "
