...
SYSTEM_PROMPT = (
    ...
    "WEB AUTOMATION: For web browsing tasks, use 'open_browser' to navigate, and use 'browser_click', 'browser_type', and 'browser_scroll' to interact directly with webpage elements reliably. "
    ...
    "In each step, decide what GUI/system/browser actions to take (open_application, open_browser, browser_click, browser_type, browser_scroll, gui_click, gui_type, gui_hotkey, execute_shell, inspect_screen, ask_user_voice). "
